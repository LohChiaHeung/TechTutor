...
public class LaptopTapHandler : MonoBehaviour
{
    [Header("UI & Visuals")]
    public GameObject canvasObject;
    public GameObject backgroundPanelObject;
    public GameObject laptopHighlightGroup;
    ...
    void Update()
    {
        ...
        if (Input.touchCount > 0 && Input.GetTouch(0).phase == TouchPhase.Began)
        {
            ...
            {
                Debug.Log("[LaptopTapHandler] Laptop tapped!");
    ...
    public void OnCloseButtonTapped()
    {
        ...
        if (laptopHighlightGroup != null)
            laptopHighlightGroup.SetActive(true);
